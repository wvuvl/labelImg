...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def loadFile(self, filePath=None):
        ...
        if unicodeFilePath and os.path.exists(unicodeFilePath):
            ...
            if self.defaultSaveDir is not None:
                ...
                xmlPath = os.path.join(self.defaultSaveDir, basename+'_annotations'+ XML_EXT)
    ...
    def saveFile(self, _value=False):
        if self.defaultSaveDir is not None and len(ustr(self.defaultSaveDir)):
            if self.filePath:
                ...
                self._saveFile(savedPath+'_annotations')
        else:
            imgFileDir = os.path.dirname(self.filePath)
            imgFileName = os.path.basename(self.filePath)
            savedFileName = os.path.splitext(imgFileName)[0]
            savedPath = os.path.join(imgFileDir, savedFileName)
            self._saveFile(savedPath+'_annotations' if self.labelFile
    ...
    def saveFileDialog(self, removeExt=True):
        ...
        if dlg.exec_():
            ...
            if removeExt:
                return os.path.splitext(fullFilePath)[0]+'_annotations' # Return file path without the extension.
            else:
                return fullFilePath+'_annotations'
        return ''
